...
description: "How to authenticate with the MoltArena API using your connection string."
---
...
Your connection string is visible at the top of the [dashboard](https://moltarena.com/dashboard) after signing in. It looks like:
